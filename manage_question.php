		...
		<div class="col-lg-12">
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								...
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>Respuesta única</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>Respuesta múltiple</option>
								<option value="textfield_s" <?php echo isset($type) && $type == 'textfield_s' ? 'selected':'' ?>>Comentario</option>
							</select>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="preview">
						<?php if(!isset($id)): ?>
						<center><b>Seleccione primero el tipo de pregunta.</b></center>
						<?php else: ?>
						      	...
						      	<thead>
							      	<tr class="">
								      	...
								      	<th class="text-center">
								      		<label for="" class="control-label">Formulario</label>
								      	</th>
								      	<th class="text-center"></th>
							     	</tr>
						     	</thead>
						...
						<?php else: ?>
								<textarea name="frm_opt" id="" cols="30" rows="10" class="form-control" disabled="" placeholder="Escribe algo aquí..."></textarea>
						<?php endif; ?>
						<?php endif; ?>
					</div>
				</div>

		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title"><b>Detalles de la encuesta</b></h3>
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						...
						<p>Veces contestada: <b><?php echo number_format($taken) ?></b></p>
			...
			<div class="card card-outline card-success">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-flat btn-sm bg-gradient-success" type="button" id="print"><i class="fa fa-print"></i> Visualizar</button>
					</div>
				</div>
						...
						<div class="col-md-12">
							...
							<?php if($row['type'] != 'textfield_s'):?>
								...
								<?php foreach(json_decode($row['frm_option']) as $k => $v): 
									$stmt2 = $conn->prepare("SELECT COUNT(*) as count FROM answers WHERE survey_id = :survey_id AND question_id = :question_id AND answer = :answer");
									$stmt2->execute(array(':survey_id' => $id, ':question_id' => $row['id'], ':answer' => $k));
									$result = $stmt2->fetch(PDO::FETCH_ASSOC);
									$count = $result['count'];
									$prog = ($count / $taken) * 100;
									$prog = round($prog, 2);
									?>
									<li>
										...
										<div class="d-flex w-100">
											<span class=""><?php echo $count ?>/<?php echo $taken ?></span>
